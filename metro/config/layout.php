...
/* Tilegroup settings */
$groupTitles = array('Home','Second tilegroup','Group 3'); // titles of the tileGroups
$groupSpacing = array(4,4,3); // width of each tileGroup (spacing between the groups in tiles)
